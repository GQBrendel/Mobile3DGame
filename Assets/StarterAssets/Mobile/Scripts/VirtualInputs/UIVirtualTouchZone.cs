...
public class UIVirtualTouchZone : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        if (handleRect2)
        {
            UpdateHandleRect2Position(outputPosition * joystickRange);
        }
    }
    ...
    private void HandleHandle(PointerEventData eventData)
    {
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        if(handleRect)
        {
            ...
            UpdateHandleRect2Position(Vector2.zero);
        }
    }
    ...
    void UpdateHandleRect2Position(Vector2 newPosition)
    {
        handleRect2.anchoredPosition = newPosition;
    }
